    ...
    <AppShell title="Angel Numbers">
      <div className="flex flex-col w-full gap-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl font-headline text-primary mb-2">Decode Your Signs</h1>
          <p className="text-foreground/80">
            Are you seeing repeating numbers? Enter a sequence below to uncover the universe's message for you.
          </p>
        </div>
