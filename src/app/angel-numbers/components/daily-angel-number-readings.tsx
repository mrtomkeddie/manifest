  ...
  return (
    <div className="w-full space-y-8">
        <div className="text-center">
            <h2 className="text-3xl font-headline text-primary">Today's Angel Number: <span className="tracking-widest">{number}</span></h2>
            <p className="text-foreground/80 mt-2">
                This is the universe's message for you today. Here's how it applies to different areas of your life.
            </p>
        </div>
